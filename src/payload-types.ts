...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'moon-registrations': MoonRegistrationsSelect<false> | MoonRegistrationsSelect<true>;
    'observe-moon-events': ObserveMoonEventsSelect<false> | ObserveMoonEventsSelect<true>;
...
export interface Division {
  ...
  slug: string;
  /**
   * A Lucide React icon name (e.g. 'Rocket', 'Bot', 'Plane')
   */
  icon: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact';
  ...
  description: string;
  /**
   * Shown on the division's dedicated page.
   */
  content: {
    root: {
      type: string;
...
export interface ObserveMoonEvent {
  ...
  partners?:
    | {
        ...
        partnershipType?:
          | ('Sponsor' | 'Global Partner' | 'Academic Partner' | 'Media Partner' | 'Equipment Partner')
          | null;
