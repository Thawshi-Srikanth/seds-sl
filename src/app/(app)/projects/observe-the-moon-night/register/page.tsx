...
export const metadata: Metadata = {
  title:
    "Event Registration | International Observe the Moon Night | SEDS Sri Lanka",
  description:
    "Register for International Observe the Moon Night with SEDS Sri Lanka. Reserve your spot for telescopic lunar observation.",
};

export default async function ObserveMoonNightDefaultRegisterPage() {
