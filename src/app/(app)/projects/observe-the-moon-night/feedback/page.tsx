...
export const metadata: Metadata = {
  title:
    "Event Feedback | International Observe the Moon Night | SEDS Sri Lanka",
  description:
    "Share your feedback and thoughts for International Observe the Moon Night with SEDS Sri Lanka.",
};

export default async function ObserveMoonNightDefaultFeedbackPage() {
